...
import {
  AboutScrollCard,
  AboutScrollProvider,
} from "@/components/about/about-scroll-card";
...
function AboutSectionCard({
  ...
  return (
    <article
      className={`${cardShell} ${accent.border} border-t-2 px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16`}
    >
      <span
        aria-hidden
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-bg">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col px-4 md:px-8">
        <AboutScrollProvider>
          <div className="flex flex-col gap-5 py-10 md:gap-6 md:py-14">
            <AboutScrollCard variant="hero">
              <section
            ...
            {bodySections.map((section, index) => (
              <AboutScrollCard key={section.label}>
                <AboutSectionCard index={index + 1} section={section} />
              </AboutScrollCard>
            ))}

            <AboutScrollCard>
              <article
                className={`${cardShell} border-(--accent)/40 border-t-2 px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16`}
              >
                <span
                  aria-hidden
                ...
                <header className="relative mb-8 md:mb-10">
                  ...
                  <p className="mt-4 max-w-md text-(--text-muted) text-sm leading-relaxed">
                    State-backed award for installation work, plus press on
                    audio tools.
                  </p>
                </header>
            ...
            {currentlySection ? (
              <AboutScrollCard variant="highlight">
                <article
                  className={`${cardShell} border-(--accent) border-t-2 bg-(--accent)/6 px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16`}
                >
            ...
            <AboutScrollCard variant="contact">
              <article
                className={`${cardShell} px-6 py-10 md:px-10 md:py-14 lg:px-14 lg:py-16`}
              >
